...
<div style="min-height: 350px;" class="container-fluid">
  <div class="row headmargin">		
       ...
       {
      	  print("<div style='font-size:20px' class='alert alert-info text-center'> <strong>File Format Not Supported!<strong><br/>The file should be in (.xlsx) format. </div> </div> </div> <hr> <div class='row'> <div class='footer' align='center'><br/><p>Copyright &copy; &middot;Gyan Ganga Group of Institutions&middot; All Rights Reserved</p></div></div><hr></div>");
      }
