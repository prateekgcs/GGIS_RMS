...
<head>
	...
	<title>Professor Reset Password</title>
				...
				<div class="col-md-7 col-md-offset-1">
					...
					<?php
						...
						if(isset($_POST['reset']))
						{
							...
							printf("<script>alert('Password updated!'); window.location.href='./professor_dashboard.php';</script>");
