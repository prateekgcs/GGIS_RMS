		...
		<?php
			...
			if(isset($_POST['add']))
			{
				...
				die("ERROR");
				  ...
				  printf("<div style='font-size:20px' class='alert alert-success text-center'> <strong>Upload Successful!<strong><br/> Data has been successfully uploaded to the database.<br/><a href='./index.php'>Click here to Login</a></div>");	
