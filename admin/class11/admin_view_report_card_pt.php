				...
				<div class='headmargin'>
					<div class='container-fluid'>
						...
						<div align='center' class='col-md-12'>
							<h3>Report Card</h3>
							<h4>Class: IX <br/>Academic Session: $year-$next_year <br/><b>Unit Test-$test_no</b></h4>
						</div>
						...
						$html1 ="
								<div class='col-md-12 mtop'>
									...
									<table class='table table-centered' border='2'>
										<tr>
											<td class='bold' colspan='2'>SCHOLASTIC AREA</td>
											
										</tr>
										<tr>
											<td class='bold'>Unit Test - $test_no</td>
